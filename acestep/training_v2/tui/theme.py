...
def register_sidestep_theme(app) -> None:
    """
    Register and activate the Side-Step theme on a Textual App.
    
    Creates and registers a Theme named "sidestep" with the module's predefined color tokens and sets the app's active theme to "sidestep". If the Textual theming API is unavailable or an error occurs, the function leaves the app unchanged.
    
    Parameters:
    	app: The Textual App instance to register the theme on.
    """
    try:
